...
if st.button("Predict Final Score"):
    ...
    # Filter numeric_cols to only include columns that exist in data_ordered
    numeric_cols_to_scale = [col for col in numeric_cols if col in data_ordered.columns]
    
    if numeric_cols_to_scale:
        data_scaled[numeric_cols_to_scale] = scaler.transform(data_ordered[numeric_cols_to_scale].values)
